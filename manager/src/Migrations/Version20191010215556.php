 ...
 */
final class Version20191010215556 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('COMMENT ON COLUMN user_users.reset_token_expiries IS \'(DC2Type:datetime_immutable)\'');
